      ...
      >
        ...
        <div className="relative w-full max-w-2xl sm:max-w-3xl perspective-[1200px] z-10 flex flex-col items-center px-2">
          ...
          <motion.div
            ...
            className="relative w-full min-h-[420px] sm:min-h-[480px] rounded-3xl bg-[#FAFCF9] border-2 border-[var(--color-gold)]/40 shadow-[0_30px_70px_rgba(42,56,40,0.18)] flex flex-col items-center justify-center p-6 sm:p-12 text-center overflow-hidden"
          >
