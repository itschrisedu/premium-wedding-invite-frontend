...
export const GallerySection: React.FC = () => {
  ...
  const photosList = galleryConfig.customPhotos && galleryConfig.customPhotos.length > 0
    ? galleryConfig.customPhotos
    : GALLERY_IMAGES;

  // Cap gallery photos to max 9 images for optimal load speed and gallery layout
  const galleryItems = [...uploadedImages, ...photosList].slice(0, 9);
