...
import { Camera, MapPin, X, ChevronLeft, ChevronRight, Maximize2, CloudUpload } from 'lucide-react';
    ...
    <section id="galeria" className="relative py-24 px-6 max-w-7xl mx-auto">
      <div className="text-center mb-16">
        ...
        <p className="mt-3 text-xs sm:text-sm text-white/70 font-sans tracking-wide uppercase max-w-xl mx-auto">
          Capturas en Golden Hour en los rincones más icónicos de Ambato y Tungurahua.
        </p>
      </div>
      ...
      {uploadedImages.length > 0 && (
        <div className="mb-8 flex items-center gap-2 text-[10px] uppercase tracking-[0.25em] text-amber-200/70 font-mono justify-center">
          ...
          <span>Fotos subidas desde el backend</span>
        </div>
      )}
