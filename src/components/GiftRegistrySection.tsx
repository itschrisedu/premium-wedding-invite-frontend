...
import { Gift, Copy, Check, Plane, Building2, CreditCard, Heart } from 'lucide-react';
    ...
    <section id="regalos" className="relative py-24 px-6 max-w-6xl mx-auto">
        ...
        {BANK_DETAILS.map((bank, idx) => (
          ...
          >
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-4 py-3.5 rounded-xl bg-orange-500 hover:bg-orange-600 text-white font-bold text-xs uppercase tracking-[0.2em] hover:scale-[1.02] active:scale-98 transition-all cursor-pointer shadow-lg"
            >
      ...
      >
        ...
        <h3 className="font-cinzel text-xl text-amber-100 mb-2">
          Luna de Miel en las Islas Galápagos & Italia
        </h3>
        <p className="text-xs text-amber-200/80 font-serif italic max-w-lg mx-auto">
          "Si prefieres aportar a las experiencias de nuestro primer viaje como esposos, tu aporte nos acompañará a crear recuerdos inolvidables."
        </p>
      </motion.div>
    </section>
  );
